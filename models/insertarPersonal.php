<?php
    ...
    $sql = "INSERT INTO personal(userPer, passPer, cedPer, nomPer, rolPer, disPer) VALUES (:user, :passPer, :cedPer, :nomPer, :rolPer, :disPer )";
    $sql2 = $pdo->prepare($sql);
    $sql2->bindParam(':user',$user,PDO::PARAM_STR,5);
    $sql2->bindParam(':passPer',$passPer,PDO::PARAM_STR,25);
